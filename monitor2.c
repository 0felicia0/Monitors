...
int main(int argc, char *argv[]){
    ...
    if (pid == 0){ /*change back*/
        ...
        /*careful with blocking all signals*/
        ...
        */
        while (1){
            ...
            sleep(10); /*fork after 10 seconds*/
            ...
            if (fork() == 0){
                ...
                while(strcmp(user_input, "q") != 0){
                    ...
                    if (strcmp(user_input, "list") == 0){
                        fprintf(stderr,"path being seen: %s\n", path);
                        print_cur_dir();
                    }
